#This script was copied over from the nice folks at code-server for setting up the AWS instance. I added it here so that I am able to run this when they push updates to the program. 
